...
class MapsTab:
    def setup(self, xce_object):
        ...
        xce_object.select_sample_for_dimple_box = QtWidgets.QCheckBox(
        ...
        set_new_reference_button = QtWidgets.QPushButton(
        ...
        # refresh button
        refresh_reference_file_list_button = QtWidgets.QPushButton(
        ...
        xce_object.reference_file_selection_combobox = QtWidgets.QComboBox()
        ...
        xce_object.maps_checkbutton_hbox = QtWidgets.QHBoxLayout()
        ...
        xce_object.popMenu_for_maps_table = QtWidgets.QMenu()
        run_dimple = QtWidgets.QAction("mark selected for dimple run", xce_object.window)
